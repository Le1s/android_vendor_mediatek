...
public class OpSneExtension extends DefaultSneExtension {
    ...
    private Context hostAppContext = null;
    ...
    private boolean isSneNicknameValid(String nickName, long subId) {
    ...
    private boolean updateDataToDb(long subId, String accountType,
    ...
    private boolean buildNicknameValueForInsert(long subId, ContentValues cv,
            String nickname) {
        if (SimUtils.hasSne(subId)) {
    ...
    private boolean hasSne(long subId) {
    ...
    public String buildSimNickname(String accountType,
            ArrayList<String> nicknameArray, long subId, String defValue) {
    ...
    public void onEditorBindEditors(RawContactDelta entity, AccountType type,
        ...
        if (SimUtils.isUsim(type.accountType)) {
            ...
            if (dataKind != null) {
                ...
                updateNickname(dataKind, hasSne(subId));
            }
    ...
    public void addDataKindNickname(AccountType accountType) {
    ...
    public void editSimSne(Intent intent, long indexInSim, long subId,
            long rawContactId) {
        ...
        if (accountType.equals(AccountType.ACCOUNT_TYPE_USIM)) {
        ...
        if (!isSneNicknameValid(sNickname, subId)) {
            {
                if (checkAlone) {
                    ...
                    hostAppContext = ContactsApplication.getInstance();
    ...
    public void updateValues(Intent intent, long subId,
    ...
    public void updateValuesforCopy(Uri sourceUri, long subId,
