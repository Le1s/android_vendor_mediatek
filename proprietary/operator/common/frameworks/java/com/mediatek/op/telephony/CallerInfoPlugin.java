...
public class CallerInfoPlugin extends CallerInfoExt {
     ...
     * @return
     */
    public CharSequence getTypeLabel(Context context, int numberType, CharSequence numberLabel, Cursor cursor, long subId) {
        int slotId = SubscriptionManager.INVALID_SLOT_ID;         
           ...
           if(subInfoRecord != null) {
                slotId = subInfoRecord.slotId; 
                }   

        String accountType = getAccountTypeBySubId(slotId, subId);
        Log.i(TAG, "[getTypeLabel] accountType=" + accountType + ", slotId=" + slotId + ", numberType=" + numberType + ",numberLabel= " + numberLabel + ", subId=" + subId + ", subInfoRecord=" + subInfoRecord);
     ...
     */
    private CharSequence getAasTypeLabel(Context context, int aasIdx, int slotId, long subId) {
        String aasLabel = "";
    ...
    private String getAccountTypeBySubId(int slotId, long subId) {
    ...
    private int getSimTypeBySubId(long subId) {
