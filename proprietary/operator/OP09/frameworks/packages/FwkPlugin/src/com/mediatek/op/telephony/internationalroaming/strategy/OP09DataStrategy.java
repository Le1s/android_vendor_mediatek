...
@PluginImpl(interfaceName="com.mediatek.common.telephony.internationalroaming.strategy")
public class OP09DataStrategy extends DefaultDataStrategy {
    ...
    public OP09DataStrategy(IInternationalRoamingController controller, Context context,
        ...
        mTelephonyProviderExt = MPlugin.createInstance(ITelephonyProviderExt.class.getName(), context);
    ...
    public long insertGsmApnForDualModeCard() {
        ...
        // TODO: need to add back code for L migration   [start]
        //long checkId = insertIrGsmApn(Telephony.Carriers.SIM2Carriers.CONTENT_URI);
        // TODO: need to add back code for L migration [end]
