            ...
            if (values == null) {
                ...
                if (mOperationList.size() > 0) {
                    try {
                        ...
                        MyLogger.logD(CLASS_TAG, "OperationApplicationException");
                    } catch (Exception e) {
...
//    private static final String DATE = "Date:";
    ...
    /**
     * @return ArrayList<SmsRestoreEntry>.
     */
           ...
           InputStream instream = new FileInputStream(file);
            ...
            while ((line = buffreader.readLine()) != null) {
                ...
                if (line.startsWith(VMESSAGE_DELIVER) && !appendbody) {
                    smsentry.setBoxType(line.substring(VMESSAGE_DELIVER.length())
                            .equals("DELIVER") ? 1 : 2);
                    Log.d(CLASS_TAG, "deliver = "
                            + (line.substring(VMESSAGE_DELIVER.length()).equals("DELIVER") ? "1"
                                    : "2"));
                }
