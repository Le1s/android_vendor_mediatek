 ...
 */
public class OP09PhoneCallDetails extends PhoneCallDetails {
    ...
    public OP09PhoneCallDetails(CharSequence number, CharSequence formattedNumber, String countryIso,
            String geocode, int[] callTypes, long date, long duration, int simId, int vtCall,
            int callCount, String ipPrefix, int displayType) {
        super(number, 0, formattedNumber, countryIso, geocode, callTypes, date, duration,
    ...
    public OP09PhoneCallDetails(CharSequence number, CharSequence formattedNumber, String countryIso,
        ...
        super(number, 0, formattedNumber, countryIso, geocode, callTypes, date, duration, name,
              numberType, numberLabel, contactUri, photoUri, simId, vtCall, callCount, ipPrefix);
        this.displayType = displayType;
    }

    public OP09PhoneCallDetails(PhoneCallDetails phoneCallDetails, int displayType) {
        this(phoneCallDetails.number, phoneCallDetails.formattedNumber, phoneCallDetails.countryIso,
             phoneCallDetails.geocode, phoneCallDetails.callTypes, phoneCallDetails.date, phoneCallDetails.duration,
    ...
    public OP09PhoneCallDetails(int displayType) {
        this(null, null, null, null, null, -1L, -1L, -1, -1, -1, null, displayType);
    }
