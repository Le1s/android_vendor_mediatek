...
/**
 * simmanagement CT feature remove some items.
 */
public class OP09SimManagementExtImp extends DefaultSimManagementExt {

    private static final String TAG = "OP09SimManagementExtImp";
     ...
     * @param pref PreferenceFragment sim colorPreference's root
     * @param key colorPreference's key
     */
    @Override
     ...
     * @param voiceList voice list
     * @param voipAvailable no use,just for other operator interface
     */
    @Override
    ...
    public boolean enableSwitchForSimInfoPref() {
        Log.d(TAG, "enableSwitchForSimInfoPref return false");
        return false;
    }
    ...
    public void updateSimNumberMaxLength(EditTextPreference editTextPreference, int slotId) {
        if (editTextPreference != null) {
            ...
            if (telephonyManagerEx != null &&
                    telephonyManagerEx.getPhoneType(slotId) == TelephonyManager.PHONE_TYPE_CDMA) {
