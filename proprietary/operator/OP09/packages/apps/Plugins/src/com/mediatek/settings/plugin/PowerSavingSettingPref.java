...
public class PowerSavingSettingPref extends CheckBoxPreference implements OnClickListener {
    ...
    /**
     * Constructor method, add new layout.
    ...
    public PowerSavingSettingPref(Context context, AttributeSet attrs) {
        ...
        Log.d(TAG, "PowerSavingSettingPref  new attrs");
    }
    ...
    private void enableSettingsButton() {
        if (mSettingsButton != null) {
            ...
            final boolean powerSavingSwitched = Settings.System.getInt(
                    mContext.getContentResolver(), PowerSavingManager.CT_POWER_SAVING_MODE, 0) == 1;
