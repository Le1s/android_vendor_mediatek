...
public class OP09SettingsMiscExtImp extends DefaultSettingsMiscExt {
    ...
    /**
     * update Default Sim Preference Layout.
     * @param pref which will be updated
     */
    ...
    /**
     * Need use OP09 context get LayoutInflater.
     * @param context use in default implement
    ...
    /**
     * update Default Sim Preference SimIndicator,sim1 different with sim2.
     * @param viewContainer parent view
     * @param color sim1 or sim2
     */
    ...
    /**
     * For DataUsageSummary feature,add sim Indicator on sim card.
     * @param container parent view
     * @param titleView tilte view
     * @param slotId sim id
     */
    public void insertSimIndicatorInMobileDataSummaryItem(View container,
        ...
        if (container instanceof RelativeLayout) {
            ...
            simIndicator.setImageResource(
                    slotId == PhoneConstants.GEMINI_SIM_1 ?
                            R.drawable.ic_datausage_sim_1 : R.drawable.ic_datausage_sim_2);
     ...
     * @param target Settings Head list
    ...
    public void initSwitherControlers() {
        ...
        Log.d(TAG, "initSwitherControlers mDataConnecitonEnabler="
                + mDataConnecitonEnabler + ", this=" + this);
    }
    ...
    public void resumeEnabler() {
        Log.d(TAG, "resumeEnabler mDataConnecitonEnabler=" +
                mDataConnecitonEnabler + ", this=" + this);
    ...
    public void pauseEnabler() {
        Log.d(TAG, "pauseEnabler mDataConnecitonEnabler=" +
                mDataConnecitonEnabler + ", this=" + this);
        if (mDataConnecitonEnabler != null) {
