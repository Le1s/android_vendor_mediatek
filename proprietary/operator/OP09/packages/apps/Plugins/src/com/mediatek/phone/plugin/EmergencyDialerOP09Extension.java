...
import com.mediatek.phone.ext.IEmergencyDialerCallback;
import com.mediatek.telephony.SimInfoManager.SimInfoRecord;
import com.mediatek.telephony.TelephonyManagerEx;

public class EmergencyDialerOP09Extension extends DefaultEmergencyDialerExt
    ...
    private IEmergencyDialerCallback mEmergencyDialer;
    ...
    public void onCreate(Activity activity, IEmergencyDialerCallback emergencyDialer) {
        ...
        try {
            mPluginContext = mActivity.createPackageContext("com.mediatek.op09.plugin", Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
        } catch (NameNotFoundException e) {
            Log.d(LOG_TAG, "no com.mediatek.op09.plugin packages");
        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.dialButtonLeft:
                ...
                placeCall(mDigits.getText().toString());
                return;
    ...
    public boolean placeCall(String lastNumber) {
        ...
        if (isECCNumber) {
            ...
            if (null == lastNumber || !TextUtils.isGraphic(lastNumber)) {
                mEmergencyDialer.playToneForPlugin(ToneGenerator.TONE_PROP_NACK);
                return true;
            }
