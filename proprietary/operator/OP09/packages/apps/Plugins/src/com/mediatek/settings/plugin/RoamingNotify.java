...
/**
 * for CT feature ,when roaming,changed the date and time.
 */
public class RoamingNotify implements View.OnClickListener {
    ...
    /**
     * @see RoamingNotify(Context context).
     * @param context RoamingService
     * @return new RoamingNotify
     */
    ...
    public void showTimeZoneRecommendInNotificationBar() {
        ...
        String notificationSummary =
            mContext.getString(R.string.time_zone_recommend_notify_summary);
        if (mNM == null) {
            mNM = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        }
        Notification notification =
            new Notification(R.drawable.ic_notification_time_zone_recommendation,
                    notificationTitle,
        ...
        backIntent.setComponent(
                new ComponentName("com.mediatek.op09.plugin",
        ...
        notification.setLatestEventInfo(
                mContext, notificationTitle,
                notificationSummary, contentIntent);
        if (mNM != null) {
    ...
    public void showTimeZoneChooseDialog() {
        ...
        // init radio button:
        mCurrentTime = Settings.System.getInt(
                mContext.getContentResolver(),
                Settings.System.CT_TIME_DISPLAY_MODE,
                BEIJING_MODE);
        ...
        AlertDialog timeZoneDialog =
            new AlertDialog.Builder(mContext).
                setTitle(R.string.time_settings_title).
                setView(view).
    ...
    /**
     * radio button click.
     * @param view which view will click
     */
