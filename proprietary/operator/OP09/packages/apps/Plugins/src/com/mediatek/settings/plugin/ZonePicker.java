...
public class ZonePicker extends ListFragment {
    ...
    public SimpleAdapter constructTimezoneAdapter(Context context, int layoutId) {
        Log.d(TAG, "constructTimezoneAdapter");
        final String[] from = new String[] {KEY_DISPLAYNAME, KEY_GMT, KEY_TIME_AND_DATE};
        final int[] to = new int[] {R.id.displayname_text, R.id.gmt_text, R.id.time_date_text};
    ...
    /**
     * Comparator for getZones Adapter.
     */
