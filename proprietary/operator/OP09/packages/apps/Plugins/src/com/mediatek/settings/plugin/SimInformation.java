...
/**
 * Sim Information detail and public API.
 */
public class SimInformation {
    ...
    private static final String NETWORK_MODE_CHANGE_BROADCAST =
        "com.android.phone.NETWORK_MODE_CHANGE";
    private static final String NETWORK_MODE_CHANGE_RESPONSE =
        "com.android.phone.NETWORK_MODE_CHANGE_RESPONSE";
    ...
    /**
     * get sim is roaming or not.
     * @param slotId simid
     * @return true if sim is roaming
     */
    public boolean getSlotRomaingStatus(int slotId) {
        boolean bSlotRoaming = mTelephonyManagerEx.isNetworkRoaming(slotId);
        Log.d(TAG, "bSlotRoaming:" + bSlotRoaming);
        return bSlotRoaming;
    }

    /**
     * get any sim is roaming or not.
     * @return true if any sim is roaming
     */
    public boolean isInternationalRoamingStatus() {
        ...
        if (mSimInfoList != null && mSimInfoList.size() == DOUBLE_SIM_CARD) {
            ...
            Log.d(TAG, "isInternationalRoamingStatus() statement1");
            ...
            Log.d(TAG, "isInternationalRoamingStatus() statement2");
        } else {
            // Error: no SIM inserted
            Log.d(TAG, "isInternationalRoamingStatus() statement3");
        }
        return isRoaming;
    }
    ...
    public List<SimInfoRecord> getSimInfo() {
        ...
        for (int i = 0; i < siminfoList.size(); i++) {
            ...
            Log.i(TAG, "siminfo.mDisplayName = " + tempSiminfo.mDisplayName);
            Log.i(TAG, "siminfo.mSlot = " + tempSiminfo.mSimSlotId);
            Log.i(TAG, "siminfo.mColor = " + tempSiminfo.mColor);
            Log.i(TAG, "siminfo.mSimId = " + tempSiminfo.mSimInfoId);
        }
        return siminfoList;
    }
