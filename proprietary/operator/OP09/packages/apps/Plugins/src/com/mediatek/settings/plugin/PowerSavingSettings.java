...
/**
 * Description: Customization for CT,Power Saving Mode.
 * Main screen
 */
public class PowerSavingSettings extends PreferenceActivity implements OnCheckedChangeListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        Log.d(TAG, "-->PowerSavingSettings onCreate()");
    ...
    private void initUI() {
        ...
        final int padding =
            getResources().getDimensionPixelSize(R.dimen.action_bar_switch_padding); // 24
    ...
    private void updateUI() {
        ...
        Log.d(TAG, "PowerSavingSettings onResume(), Power Saving Switch: " + isPoSavingChecked);
        ...
        if (mOldBrightnessProgress == -1) {
            mOldBrightnessProgress =
                (MAXIMUM_BACKLIGHT - mScreenBrightnessDim) / TEN + mScreenBrightnessDim;
        } else {
            mBrightnessPreference.setSummary(
                    getBrightnessPercent(mOldBrightnessProgress - mScreenBrightnessDim));
        }
    ...
    private String getBrightnessPercent(float currentBrightness) {
        float brightnessPercent =
            currentBrightness / (float) (MAXIMUM_BACKLIGHT - mScreenBrightnessDim);
        NumberFormat nf = NumberFormat.getPercentInstance();
        // nf.setMinimumFractionDigits(2);
        String percent = nf.format(brightnessPercent);
        Log.d(TAG, "Max brightness: " + MAXIMUM_BACKLIGHT +
                "Current Brightness" + currentBrightness + "Precent progress: "
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        boolean isPoSavingChecked = mPowerSavingManager.isPowerSavingModeOn();
        Log.d(TAG, "-->Switch onCheckedChanged() -- " + isChecked + ", " + isPoSavingChecked);
        if (isPoSavingChecked == isChecked) {
            // Maybe the power savings state is changed in other way,
            // then enter this screen,the switch will change.
            // Don't care this change
            Log.d(TAG, "-->Don't care this change -- ");
            return;
        }
    ...
    private Dialog createBrightnessDialog() {
        ...
        final CheckBox autoCheckBox =
            (CheckBox) view.findViewById(R.id.power_saving_brightness_checkbox);
        ...
        autoCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton dialog, boolean checked) {
                Log.d(TAG, "BrightnessDialog1: onClick checkbox -> " + checked);
        ...
        Log.d(TAG, "onCreateDialog() current brightness is " + currentBrightness);
        ...
        seekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                Log.d(TAG, "BrightnessDialog1: onProgressChanged -> " + progress);
            ...
            new AlertDialog.Builder(this).
                ...
                setPositiveButton(android.R.string.ok,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            mBrightnessPreference.setSummary(
                                    getBrightnessPercent((float) seekBar.getProgress()));
                ...
                setNegativeButton(android.R.string.cancel,
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Log.d(TAG, "-->brightnessDialog -- onClick Cancel");
                            // restore
                            mPowerSavingManager.
                                setBrightness(mOldBrightnessProgress);
                            mPowerSavingManager.setBrightnessAutoMode(
                                    mOldBrightnessAutoChecked ? 1 : 0);
                            Log.d(TAG, " -- onClick Cancel, old brightness is: " +
                                    mOldBrightnessProgress);
                            mBrightnessPreference.setSummary(
                                    getBrightnessPercent(
                                            mOldBrightnessProgress - mScreenBrightnessDim));
                    ...
                    public void onCancel(DialogInterface dialog) {
                        Log.d(TAG, "-->brightnessDialog -- OnCancel()");
                        mOldBrightnessAutoChecked = autoCheckBox.isChecked();
                        mOldBrightnessProgress = seekBar.getProgress() + mScreenBrightnessDim;
                        saveBrightness(mOldBrightnessProgress, mOldBrightnessAutoChecked);
                        mBrightnessPreference.setSummary(
                                getBrightnessPercent(
                                        (float) mOldBrightnessProgress - mScreenBrightnessDim));
                    }
                }).
                create();
        ...
        switch (dialogId) {
            ...
            case SLEEP_DIALOG:
                ...
                return new AlertDialog.Builder(this).
                    setSingleChoiceItems(R.array.screen_timeout_entries, checkedItem,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int position) {
                                ...
                                mSleepPreference.setSummary(
                                        getString(R.string.screen_timeout_summary, getResources()
