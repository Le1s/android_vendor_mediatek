...
/**
 * for cu feature add data on/off in Settings.
 */
public class DataConnectionSettings extends PreferenceActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        Switch actionBarSwitch =
            (Switch) inflater.inflate(com.mediatek.internal.R.layout.imageswitch_layout, null);
    ...
    private void updateScreen() {
        ...
        boolean slot1RadioOn =
            DataConnectionEnabler.isTargetSlotRadioOn(PhoneConstants.GEMINI_SIM_1);
        boolean slot2RadioOn =
            DataConnectionEnabler.isTargetSlotRadioOn(PhoneConstants.GEMINI_SIM_2);
    ...
    private void handleDataConnectionChange(int newSlot) {
        ...
        if (newSlot >= PhoneConstants.GEMINI_SIM_1
                && DataConnectionEnabler.getSimIndicator(this, newSlot)
                == PhoneConstants.SIM_INDICATOR_LOCKED) {
    ...
    private static int getDataConnectionSlotId(Context context) {
        // Data framework defined that this id is actual (slotId + 1),
        // we need to minus 1 before return
        return (int) Settings.System.getLong(
                context.getContentResolver(), Settings.System.GPRS_CONNECTION_SETTING,
