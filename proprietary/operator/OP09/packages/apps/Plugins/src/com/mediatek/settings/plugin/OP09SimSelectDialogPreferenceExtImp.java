...
public class OP09SimSelectDialogPreferenceExtImp extends DefaultSimSelectDialogPreferenceExt {
    ...
    /**
     * Constructor method.
     * @param baseContext is Settings's context.
     */
     ...
     * @param pref SimSelectDialogPreference
     */
    ...
    /**
     * For CT dual sim indicator design: Add sim indicator to left of summary.
     * update Default SimPreference SimIndicator.
     * @param viewContainer view container
     * @param simInfos list of sim
     * @param index index of sim
     */
