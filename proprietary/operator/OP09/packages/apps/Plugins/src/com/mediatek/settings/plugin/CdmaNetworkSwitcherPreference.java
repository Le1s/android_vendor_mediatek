...
public class CdmaNetworkSwitcherPreference extends Preference implements OnClickListener {
    ...
    /**
     * Constructor with Context, AttributeSet, default style.
     * @param context Input Context
     * @param attrs Input AttributeSet
    ...
    /**
     * Update network searching state.
     * @param searching If on searching state.
     */
    ...
    /**
     * The listener interface of network switching.
     *
     */
    public interface OnSwitchNetworkListener {
        /**
         * The callback of network switching.
         */
