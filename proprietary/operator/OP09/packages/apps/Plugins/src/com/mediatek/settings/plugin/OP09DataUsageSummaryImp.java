...
/**
 * CT feature customize overviewTabAdapter.
 */
public class OP09DataUsageSummaryImp extends DefaultDataUsageSummaryExt {
     ...
     * @param titleView title View
     * @param slotId sim1 or other
     */
    @Override
     ...
     * @param activity DataUsageSummary
     * @param tag tab1 indector or other
     * @param tab tab1 or other
     * @param tabWidget tab root
     * @param title simTitle text
     * @return new TabSpec
     */
    @Override
