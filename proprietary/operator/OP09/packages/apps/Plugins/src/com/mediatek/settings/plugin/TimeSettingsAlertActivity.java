...
/**
 * For CT feature time alert dialog.
 */
public class TimeSettingsAlertActivity extends AlertActivity
    ...
    void createDialog() {
        ...
        mCurrentTime = Settings.System.getInt(
                getContentResolver(), Settings.System.CT_TIME_DISPLAY_MODE, BEIJING_MODE);
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            case R.id.beijing_radio:
                Log.d(TAG, "onClick -- beijing_radio");
                mRadioBtn1.setChecked(true);
                mRadioBtn2.setChecked(false);
                mCurrentTime = BEIJING_MODE;
                break;
            case R.id.local_radio:
                Log.d(TAG, "onClick -- local_radio");
                mRadioBtn1.setChecked(false);
                mRadioBtn2.setChecked(true);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == BUTTON_POSITIVE) {
            Log.d(TAG, "Pressed OK -- mCurrentTime = " + mCurrentTime);
