...
public class CurrentNetworkInfoStatus extends PreferenceActivity {
            ...
            switch (msg.what) {
                case EVENT_GET_OPLMN_VERSION:
                    ...
                    if (ar.exception != null) {
                        ...
                        Xlog.d(TAG, "EVENT_GET_OPLMN_VERSION, oplmnVersion = " + oplmnVersion +
                                " mCdmaPhone = " + mCdmaPhone);
                        if (mCdmaPhone != null) {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                int dualMode = intent.getIntExtra(Intent.EXTRA_MSIM_MODE, -1);
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onSignalStrengthsChanged(SignalStrength signalStrength) {
            if (signalStrength.getMySimId() == mSimId) {
                ...
                Xlog.d(TAG, "onSignalStrengthsChanged, mSimId : " + mSimId +
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            if (serviceState.getMySimId() == mSimId) {
                ...
                Xlog.d(TAG, "onServiceStateChanged, mSimId : " + mSimId + " mServiceState : " +
                    mServiceState);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /*
         * M: simId == -1 is not supproted happen and usually it is caused by 3rd party app so to
         * compatibilty add this catch.
         */
        if (mSimId == -1) {
    ...
    private void setMccMnc() {
        ...
        switch (mSimId) {
            ...
            case PhoneConstants.GEMINI_SIM_2:
                numeric = SystemProperties.get(TelephonyProperties.PROPERTY_OPERATOR_NUMERIC_2,
                        "-1");
                break;
            default:
                numeric = SystemProperties.get(TelephonyProperties.PROPERTY_OPERATOR_NUMERIC, "-1");
    ...
    private void getOplmnVersion() {
        ...
        if (mSimId == PhoneFactory.getExternalModemSlot()) {
            PhoneProxy phoneProxy = (PhoneProxy) mGeminiPhone.getPhonebyId(
    ...
    void updateSignalStrength() {
        ...
        if (mSignalStrengthPreference != null) {
            ...
            if ((ServiceState.STATE_OUT_OF_SERVICE == mServiceState) ||
                ...
                Xlog.d(TAG, "updateSignalStrength, ServiceState is't ready, set signalStrength 0");
    ...
    /**
     * Get phone by slotId.
     * @param geminiPhone Input phone object.
     * @param slotId Input the id of slot.
     * @return Phone
     */
    public static Phone getPhoneBySlotId(Phone geminiPhone, int slotId) {
        if (geminiPhone != null && geminiPhone instanceof GeminiPhone) {
            ...
            Xlog.w(TAG, "getPhoneBySlotId phone is null or type is not GeminiPhone, geminiPhone="
                + geminiPhone);
            return null;
        }
    }
