...
public class PowerSavingPreference extends Preference implements OnCheckedChangeListener {
    ...
    /**
     * @param context com.android.settings
     */
    public PowerSavingPreference(Context context) {
        super(context);
        Log.d(TAG, "new PowerSavingPreference");
    ...
    public View getView(View convertView, ViewGroup parent) {
        Log.d(TAG, "PowerSavingPreference getView()");
        ...
        if (mPowerSavingSwitch != null) {
            ...
            Log.e(TAG, " -- > Power Saving Switch == null");
        }
        return view;
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isPoSavingChecked == isChecked) {
            ...
            Log.i(TAG, "-->Don't care this change -- ");
            return;
        }
