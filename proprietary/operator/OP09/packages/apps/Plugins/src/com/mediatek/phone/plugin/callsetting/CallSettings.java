...
/**
 * Description:Customization for CT,Call Setting.
 */
public class CallSettings extends Activity {
        ...
        if (mNotStopped) {
            ...
            if (simSize > 0) {
                ...
                getFragmentManager().beginTransaction().
                    replace(android.R.id.content, generalFrag, FRAGMENT_TAG_GENERAL).commit();
            }
        }
    }
    ...
    private void setScreenEnabled() {
        boolean isAirplaneOn =
            Settings.System.getInt(getContentResolver(), Settings.Global.AIRPLANE_MODE_ON, -1) > 0;
        int simSize = mSimList.size();
        String indexTag;
        Fragment indexFrag;
        ...
        for (int i = 0; i < simSize; i++) {
            ...
            if (!isAirplaneOn) {
                ...
                Log.d(TAG, "setScreenEnabled indexSimSlot=" +
                        indexSimSlot + ", indexTag=" + indexTag
            ...
            if (indexFrag instanceof PreferenceFragment) {
                ...
                indexPreferenceFrag.getPreferenceScreen().
                    setEnabled(!isAirplaneOn && indexSlotRadioOn);
            }
        }
    }
    ...
    private boolean slotRadioOn(int slotId) {
        ...
        try {
            if (mTelephonyEx != null) {
                ...
                Log.d(TAG, "Slot " + slotId + " is in radion state " + isRadioOn);
            }
        } catch (RemoteException e) {
            Log.w(TAG, "mTelephonyEx exception");
        }
        return isRadioOn;
    }
    ...
    /**
     * Map slotid with slotString.
     * @param slotId slot id
     * @return slot string map id
     */
    ...
    /**
     * Map slot string with slotid.
     * @param tag slot string
     * @return slot id  map string
     */
    ...
    private TabListener createTabListener(int slotId, int phoneType) {
        switch (phoneType) {
            case PhoneConstants.PHONE_TYPE_CDMA:
                return new TabListener<CdmaCallSettings>(
                        this, getSimTagBySlotId(slotId), CdmaCallSettings.class);
            case PhoneConstants.PHONE_TYPE_GSM:
                return new TabListener<GsmCallSettings>(
                        this, getSimTagBySlotId(slotId), GsmCallSettings.class);
            case PHONE_TYPE_FOR_GENERAL_TAB:
                return new TabListener<GeneralCallSettings>(
                        this, FRAGMENT_TAG_GENERAL, GeneralCallSettings.class);
            default:
                throw new IllegalArgumentException();
        }
    }
    ...
    public static class TabListener<T extends Fragment> implements ActionBar.TabListener {
        ...
        /**
         * Constructor method.
         * @param activity CallSettings
         * @param tag sim tag string
         * @param clz GSMCallSetting/CdmaCallSettings/GeneralCallSettings
         */
        ...
        /**
         * when tab select.
         * @param tab CDMACall/GSMCall/GeneralCall tab
