        ...
        if (sim1_mode == 0 || sim2_mode == 0) {
            ...
            while(!is_md_ready && md_retry < RETRY_TIMES) {
                ...
                if (fd_mdreset >= 0 && md_flag == 0) {
                    ...
                    //K2 is byte 6, others is byte 4
                    is_md_ready = (state_buf[6] == '2') || (state_buf[6] == '2');
                } else {
        ...
        if (!sim->test_done) {
            ...
            if (isEsims == 1) {
                ...
                if(swtich_to_SIM2) {
                    ...
                    //FIXME: To remove the macro after Denali SMT
...
#else
    #if defined(MTK_DT_SUPPORT) && !defined(EVDO_DT_VIA_SUPPORT)
