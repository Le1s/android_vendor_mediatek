...
SEC_IMG_CUST_DIR = vendor/mediatek/proprietary/custom/$(MTK_PROJECT)/security/image_auth
...
# set to base project if MTK_PROJECT_FOLDER is empty, MTK_PROJECT represents base project
ifeq ($(strip $(MTK_PATH_CUSTOM)),)
  MTK_PATH_CUSTOM := $(MTK_PROJECT)
endif
...
ifeq ($(MTK_DEPENDENCY_AUTO_CHECK), true)
	...
	$(hide) perl $(SECFL_PL) $(MTK_PROJECT_NAME) $(MTK_PROJECT) $(DEAL_STDOUT_SIGN_SECFL)
	$(hide) make -j24 snod
	$(hide) perl $(SIGN_TOOL) $(MTK_PROJECT) $(MTK_PROJECT_NAME) $(MTK_PATH_CUSTOM) $(MTK_SEC_SECRO_AC_SUPPORT) $(MTK_NAND_PAGE_SIZE) $(PRODUCT_OUT) $(DEAL_STDOUT_SIGN_IMAGE)
