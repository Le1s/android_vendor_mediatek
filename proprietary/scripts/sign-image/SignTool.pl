...
my @imgs_need_sign = ("system.img", "userdata.img");
...
if (${secro_ac} eq "yes")
{
	system("./$secro_script $secro_def_cfg $base_prj $custom_dir $secro_ac $secro_def_out $secro_type") == 0 or die "SECRO post process return error\n";
}
