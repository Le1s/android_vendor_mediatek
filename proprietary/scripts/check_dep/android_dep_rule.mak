...
ifneq ($(strip $(MTK_INTERNAL)),yes)
ifeq ($(strip $(MTK_TABLET_HARDWARE)),mt8752)
  ifneq ($(strip $(MTK_PLATFORM_OPTIMIZE)),yes)
    $(call dep-err-common, please set MTK_PLATFORM_OPTIMIZE=yes when MTK_TABLET_HARDWARE=mt8752)
  endif
  ifneq ($(strip $(MTK_HW_ENHANCE)),yes)
    $(call dep-err-common, please set MTK_HW_ENHANCE=yes when MTK_TABLET_HARDWARE=mt8752)
  endif
endif
endif
