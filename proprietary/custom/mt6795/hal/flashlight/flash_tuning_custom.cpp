...
{
    int dutyI[] = {93,187,280,374,468,562,655,749,843,937,1030,1124,1218,1312,1405,1499};
	int dutyLtI[] = {93,187,280,374,468,562,655,749,843,937,1030,1124,1218,1312,1405,1499};
...
FLASH_PROJECT_PARA& cust_getFlashProjectPara (int aeScene, int isForceFlash, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	para.coolTimeOutPara.tabId[2]=7;
	...
	para.coolTimeOutParaLT.tabId[2]=7;
	para.coolTimeOutParaLT.tabId[3]=10;
	para.coolTimeOutParaLT.tabId[4]=14;
