...
startOne(SensorParam const & rSensorParam)
{
    ...
    do
    {
        const char *fname = "/proc/chip/sw_ver";
        char str[8] = {0};
        ...
        mPerfService = (strncmp(str, "0000", rd_size) == 0);
    ...
    ********************************************************************************/
    {
        ...
        MY_LOGD("mfllthread all(%ld|%ld|%ld|%ld|%ld|%ld|%ld|%ld|%ld|%ld)"
                , mThreadMemory
                , mThreadCapture
                , mThreadRawToYuy2
                , mThreadYuy2ToYv16
        ...
        MY_LOGD("mfllthread mem(%ld), cap(%ld), rawToYuy2(%ld), yuy2ToYv16(%ld) mfll(%ld), memc(%ld), blend(%ld), pv(%ld), full(%ld), thumbnail(%ld)"
                , mThreadMemory
                , mThreadCapture
                , mThreadRawToYuy2
                , mThreadYuy2ToYv16
    ...
    if (eShotMode_ZsdMfllShot == meShotMode){
        ...
        #if 0
        {
            ...
            if(p3A) {
                ...
                p3A->send3ACtrl(E3ACtrl_SetAEContinueShot, MTRUE, 0);
