...
MBOOL AwbMgr::doCapAWB(MINT32 i4SceneLV, MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (m_bEnableAWB && (((!m_bAWBLock) && (!m_bAdbAWBLock)) || (m_i4StrobeMode == AWB_STROBE_MODE_ON)) && (m_eAWBMode != LIB3A_AWB_MODE_OFF))
    {
		...
		//Golden Gain for Dynamic CCM
                FLASH_AWB_CAL_GAIN_INPUT_T FlashAwbCalGainInput_Golden;
                FLASH_AWB_OUTPUT_T FlashAwbOutput_Golden;

                FlashAwbCalGainInput_Golden.NoFlashWBGain = m_rAWBOutput.rAWBInfo.rAlgGain;
                FlashAwbCalGainInput_Golden.PureFlashWBGain = m_pNVRAM_3A->rFlashAWBNVRAM.rCalibrationData.flashWBGain[m_flashDuty];
                FlashAwbCalGainInput_Golden.PureFlashWeight = m_flashAwbWeight;
	
                m_pIAwbAlgo->Flash_Awb_calResultGain(FlashAwbCalGainInput_Golden, FlashAwbOutput_Golden);
  		  m_rAWBOutput.rAWBInfo.rAlgGain.i4R = FlashAwbOutput_Golden.rAWBGain.i4R;
  		  m_rAWBOutput.rAWBInfo.rAlgGain.i4G = FlashAwbOutput_Golden.rAWBGain.i4G;
		  m_rAWBOutput.rAWBInfo.rAlgGain.i4B = FlashAwbOutput_Golden.rAWBGain.i4B;
