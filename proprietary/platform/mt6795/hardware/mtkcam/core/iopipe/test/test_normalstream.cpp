...
int pass2_IP_TPipe_Test(int casenum, int type);
...
void applyV1Tunning_IP_TPipe(MINT32 magicNum);
...
#include "pic/imgi_10240x100_bayer10.h"
            ...
            case 0:
                {
                    ...
                    #else
                    pCCStream= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
                    #endif
                    pCCStream->init();
                    //////////////////////////
            ...
            case 1:
                {
                      ...
                      #else
                      pIPStream2 = NSCam::NSIoPipe::NSPostProc::IFeatureStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::EFeatureStreamTag_PRaw_Stream,0xFFFF);
                      #endif
    ...
    {    // temp use 960x640, TO DO 2560x1440 later
        ...
        switch (multiThread_type)
        {
            ...
            case 0:
                ...
                #else
                pStreamObj= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
                #endif
                break;
            case 1:
                #if HAVE_V3
                ...
                #else
                pStreamObj= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance("onThreadLoop", NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Vss,0xFFFF);
                #endif
                break;
        }
        pStreamObj->init();
...
//	LOG_INF("QQ : testcaseType(%d),testcaseNum(%d),testtype(%d)"testcaseType,testcaseNum,testtype);
    ...
    switch(testcaseType)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            ret=pass2_IP_TPipe_Test(testcaseNum,testtype);
            break;
        default:
            break;
    }
...
int pass2_BasicTest(int casenum, int type)
{
...

    {
        ...
        #else
        pStream= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
        #endif
...
int pass2_BasicTest_ip_raw(int casenum, int type)
{
        ...
        #else
        pStream = NSCam::NSIoPipe::NSPostProc::IFeatureStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::EFeatureStreamTag_PRaw_Stream,0xFFFF);
        #endif
        pStream->init();
        IMemDrv* mpImemDrv=NULL;
        mpImemDrv=IMemDrv::createInstance();
...
//                ISP_WRITE_BITS(mpIspDrv,CAM_CTL_SPARE3,INT_MRG, 1, ISP_DRV_USER_ISPF);
                ...
                #else
                pCCStream= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance("pass2_loopTest", NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
                #endif
                pCCStream->init();
                //////////////////////////
                //prepare dma data, imgi
...
void *Vss_Thread(void *data)
{
    ...
    #else
    NSCam::NSIoPipe::NSPostProc::INormalStream* pStream = NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance(LOG_TAG,NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Vss,0xFFFF);
    #endif
...
#define P2_TUNINGQUE_NUM    10
    ...
    #else
    NSCam::NSIoPipe::NSPostProc::INormalStream* pStream = NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance(LOG_TAG,NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
    #endif
    LOG_INF("casenum(%d)\n",casenum);
...
//	    applyTuningSetting(1, &pIspPhyReg[0]);
    ...
    TUNING_MGR_REG_IO_STRUCT g_g2cShadeData[] =
        {{0x00004BB8, 0x0118000E},
        {0x00004BBC, 0x0074B740},
        {0x00004BC0, 0x00000133},
        {0x00004BC4, 0x079F0A5A},
        {0x00004BC8, 0x00000000}};

    TUNING_MGR_REG_IO_STRUCT g_obData[] =
        {{0x00004500, 0x00001EFC},
        {0x00004504, 0x00001EFC},
        {0x00004508, 0x00001EFC},
        {0x0000450C, 0x00001EFC},
        {0x00004510, 0x00000230},
        {0x00004514, 0x00000230},
        {0x00004518, 0x00000230},
        {0x0000451C, 0x00000230}};

    TUNING_MGR_REG_IO_STRUCT g_bnrData[] =
        {{0x00004800, 0x00000001},
        {0x00004804, 0x000C606E},
        {0x00004808, 0x00000258},
        {0x0000480C, 0xB1200100},
        {0x00004810, 0xBB2C616E},
        {0x00004814, 0x00030031},
        {0x00004818, 0x05010519},
        {0x0000481C, 0x00000000},
        {0x00004820, 0x00000000},
        {0x00004824, 0x000C606E},
        {0x00004828, 0x00000258},
        {0x0000482C, 0xB1200100},
        {0x00004830, 0x00114FF0},
        {0x00004834, 0x00000241},
        {0x00004838, 0x04000282},
        {0x0000483C, 0x040001F5},
        {0x00004840, 0x00000FFC},
        {0x00004844, 0x000000D6},
        {0x00004848, 0x00000000},
        {0x0000484C, 0x00000000},
        {0x00004850, 0x00000000},
        {0x00004854, 0x10A00A04}};

    TUNING_MGR_REG_IO_STRUCT g_lscData[] =
        {{0x00004530, 0x30000000},
        {0x00004534, 0x0000F082},
        {0x00004538, 0x0000F060},
        {0x0000453C, 0x008A0068},
        {0x00004540, 0x20202020},
        {0x00004544, 0x00000000},
        {0x00004548, 0x00000000},
        {0x0000454C, 0x00000000}};

    TUNING_MGR_REG_IO_STRUCT g_lsciData[] =
        {{0x0000726C, 0x07100000},
        {0x00007270, 0x00000000},
        {0x00007274, 0x000003FF},
        {0x00007278, 0x0000000F},
        {0x0000727C, 0x00000400}};
...
void applyV1Tunning_IP_TPipe(MINT32 magicNum)
{
    ...
    //[1]get instance
    TuningMgr::getInstance().init();
    TuningMgr::getInstance().flushSetting(eSoftwareScenario_Main_IP_Raw_TPipe_Stream);
    TuningMgr::getInstance().dequeBuffer(eSoftwareScenario_Main_IP_Raw_TPipe_Stream,magicNum);

    printf("Tuning: dequeBuffer done\n");
    
    //[2]update
    //
    //G2G
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_G2g);
    for(i=0;i<sizeof(g_g2gData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_g2gData[i].Addr;
        regIo[i].Data = g_g2gData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_g2gData)/sizeof(TUNING_MGR_REG_IO_STRUCT));
    
    //
    //G2C conv
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_G2c_Conv);
    for(i=0;i<sizeof(g_g2cConvData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_g2cConvData[i].Addr;
        regIo[i].Data = g_g2cConvData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_g2cConvData)/sizeof(TUNING_MGR_REG_IO_STRUCT));
    
    //
    //G2C shade
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_G2c_Shade);
    for(i=0;i<sizeof(g_g2cShadeData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_g2cShadeData[i].Addr;
        regIo[i].Data = g_g2cShadeData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_g2cShadeData)/sizeof(TUNING_MGR_REG_IO_STRUCT));

    //
    //OB
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_Obc);
    for(i=0;i<sizeof(g_obData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_obData[i].Addr;
        regIo[i].Data = g_obData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_obData)/sizeof(TUNING_MGR_REG_IO_STRUCT));

    //
    //BNR
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_Bnr);
    for(i=0;i<sizeof(g_bnrData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_bnrData[i].Addr;
        regIo[i].Data = g_bnrData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_bnrData)/sizeof(TUNING_MGR_REG_IO_STRUCT));

    //
    //LSC
    TuningMgr::getInstance().updateEngine(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, eTuningMgrFunc_Lsc);
    for(i=0;i<sizeof(g_lscData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_lscData[i].Addr;
        regIo[i].Data = g_lscData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_lscData)/sizeof(TUNING_MGR_REG_IO_STRUCT));
    for(i=0;i<sizeof(g_lsciData)/sizeof(TUNING_MGR_REG_IO_STRUCT);i++){
        regIo[i].Addr = g_lsciData[i].Addr;
        regIo[i].Data = g_lsciData[i].Data;
    }
    TuningMgr::getInstance().tuningMgrWriteRegs(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, regIo, sizeof(g_lsciData)/sizeof(TUNING_MGR_REG_IO_STRUCT));

    printf("Tuning: updateEngine & writeRegs done\n");


    TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P1, OB_EN, 0x01);
    TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P1, BNR_EN, 0x01);
    //TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P1, LSC_EN, 0x01);
    //TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P1_DMA, LSCI_EN, 0x01);
    TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P2, G2G_EN, 0x01);
    TUNING_MGR_WRITE_ENABLE_BITS(eSoftwareScenario_Main_IP_Raw_TPipe_Stream, CAM_CTL_EN_P2, G2C_EN, 0x01);

    //
    TuningMgr::getInstance().enqueBuffer(eSoftwareScenario_Main_IP_Raw_TPipe_Stream,magicNum);
    printf("Tuning: updateEngine & writeRegs done\n");
...
int pass2_BurstQueueTest(int casenum, int type)
{
        ...
        printf("QQ : casenum(%d),type(%d) \n",casenum,type);
            ...
            else if(casenum==1)
            {
                ...
                mpImemDrv->allocVirtBuf(&img2oBuf_2);
                memset((MUINT8*)img2oBuf_2.virtAddr, 0xffffffff, img2oBuf_2.size);
                MUINT32 bufStridesInBytes_2[3] = {2560, 0, 0};
                PortBufInfo_v1 portBufInfo_2 = PortBufInfo_v1( img2oBuf_2.memID,img2oBuf_2.virtAddr,0,img2oBuf_2.bufSecu, img2oBuf_2.bufCohe);
...
int pass2_IP_TPipe_Test(int casenum, int type)
{
        ...
        printf("QQ : casenum(%d),type(%d) \n",casenum,type);
            ...
            NSCam::NSIoPipe::NSPostProc::IFeatureStream* pStream;
            #if HAVE_V3
            pStream= NSCam::NSIoPipe::NSPostProc::IFeatureStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::EFeatureStreamTag_IPRAWTPipe_Stream,0xFFFF, isV3);
            #else
            //pStream= NSCam::NSIoPipe::NSPostProc::INormalStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::ENormalStreamTag_Prv,0xFFFF);
            pStream= NSCam::NSIoPipe::NSPostProc::IFeatureStream::createInstance(LOG_TAG, NSCam::NSIoPipe::NSPostProc::EFeatureStreamTag_IPRAWTPipe_Stream,0xFFFF);
            #endif   
            pStream->init();
            IMemDrv* mpImemDrv=NULL;
            mpImemDrv=IMemDrv::createInstance();
            ...
            IspDrvShell* m_pIspDrvShell = IspDrvShell::createInstance();
            m_pIspDrvShell->init();
            //m_pIspDrvShell->updateBurstQueueNum(1);
            ...
            IImageBuffer* imageBuffer_640x480_b10;
            IImageBuffer* imageBuffer_1280x720_b10;
            IImageBuffer* imageBuffer_2560x1440_b10;
            IImageBuffer* imageBuffer_10240x5760_b10;
            IImageBuffer* imageBuffer_6400x504_b10;
                ...
                {
                    MINT32 bufStridesInBytes[3] = {1600, 0, 0};
                    imgiBuf.size=sizeof(g_imgi_array_1280x720_b10);
                    mpImemDrv->allocVirtBuf(&imgiBuf);
                    memcpy( (MUINT8*)(imgiBuf.virtAddr), (MUINT8*)(g_imgi_array_1280x720_b10), imgiBuf.size);
                    //imem buffer 2 image heap
                    ...
                    sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                    imageBuffer_1280x720_b10 = pHeap->createImageBuffer();
                    imageBuffer_1280x720_b10->incStrong(imageBuffer_1280x720_b10);
                    imageBuffer_1280x720_b10->lockBuf(LOG_TAG,eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN);
                }
                else if((casenum==2))
                {
                    MINT32 bufStridesInBytes[3] = {3200, 0, 0};
                    imgiBuf.size=sizeof(g_imgi_array_2560x1440_b10);
                    mpImemDrv->allocVirtBuf(&imgiBuf);
                    memcpy( (MUINT8*)(imgiBuf.virtAddr), (MUINT8*)(g_imgi_array_2560x1440_b10), imgiBuf.size);
                    //imem buffer 2 image heap
                    ...
                    sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                    imageBuffer_2560x1440_b10 = pHeap->createImageBuffer();
                    imageBuffer_2560x1440_b10->incStrong(imageBuffer_2560x1440_b10);
                    imageBuffer_2560x1440_b10->lockBuf(LOG_TAG,eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN);
                }
                else if((casenum==3))
                {
                    MINT32 bufStridesInBytes[3] = {8000, 0, 0};
                    imgiBuf.size=sizeof(g_imgi_array_6400x504_b10);
                    mpImemDrv->allocVirtBuf(&imgiBuf);
                    printf("allocate INFO: size:0x%x, VA:0x%x, PA:0x%x\n", imgiBuf.size, imgiBuf.virtAddr, imgiBuf.phyAddr);
                    memcpy( (MUINT8*)(imgiBuf.virtAddr), (MUINT8*)(g_imgi_array_6400x504_b10), imgiBuf.size);
                    //imem buffer 2 image heap
                    PortBufInfo_v1 portBufInfo = PortBufInfo_v1( imgiBuf.memID,imgiBuf.virtAddr,0,imgiBuf.bufSecu, imgiBuf.bufCohe);
                    IImageBufferAllocator::ImgParam imgParam = IImageBufferAllocator::ImgParam((eImgFmt_BAYER10), MSize(6400, 504), bufStridesInBytes, bufBoundaryInBytes, 1);
                    sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                    imageBuffer_6400x504_b10 = pHeap->createImageBuffer();
                    imageBuffer_6400x504_b10->incStrong(imageBuffer_6400x504_b10);
                    imageBuffer_6400x504_b10->lockBuf(LOG_TAG,eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN);
                }
                else if((casenum==4))
                {
                    MINT32 bufStridesInBytes[3] = {3200, 0, 0};
            ...
            else if(casenum==1)
            {
                src.mPortID=IMGI;
                src.mPortID.group=0;
                src.mBuffer=imageBuffer_1280x720_b10;
                enqueParams.mvIn.push_back(src);
            }
            else if(casenum==2)
            {
                src.mPortID=IMGI;
                src.mPortID.group=0;
                src.mBuffer=imageBuffer_2560x1440_b10;
                enqueParams.mvIn.push_back(src);
            }
            else if(casenum==3)
            {
                src.mPortID=IMGI;
                src.mPortID.group=0;
                src.mBuffer=imageBuffer_6400x504_b10;
                enqueParams.mvIn.push_back(src);
            }
            else if(casenum==4)
            {
            ...
            switch (casenum)
            {
                ...
                case 2:
                    ...
                    crop.mResizeDst.w=2560;
                    crop.mResizeDst.h=1440;
                    break;
                case 3:
                    crop.mCropRect.p_fractional.x=0;
                    crop.mCropRect.p_fractional.y=0;
                    crop.mCropRect.p_integral.x=0;
                    crop.mCropRect.p_integral.y=0;
                    crop.mCropRect.s.w=6400;
                    crop.mCropRect.s.h=504;
                    crop.mResizeDst.w=6400;
                    crop.mResizeDst.h=504;
                    break;
                case 4:
                    crop.mCropRect.p_fractional.x=0;
                    crop.mCropRect.p_fractional.y=0;
            ...
            {    //imgi in/img2o out, test isp only mode (bypass mdp)
                ...
                memset((MUINT8*)wdmaoBuf.virtAddr, 0xffffffff, wdmaoBuf.size);
                MUINT32 bufStridesInBytes[3] = {1280, 0, 0};
                PortBufInfo_v1 portBufInfo = PortBufInfo_v1( wdmaoBuf.memID,wdmaoBuf.virtAddr,0,wdmaoBuf.bufSecu, wdmaoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(640, 480),  bufStridesInBytes, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                printf("QQ : Before create image buffer\n");
                outBuffer = pHeap->createImageBuffer();
                outBuffer->incStrong(outBuffer);
                outBuffer->lockBuf(LOG_TAG,eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN);
            }
            else if(casenum==1)
            {
                ...
                MUINT32 bufStridesInBytes[3] = {2560, 0, 0};
                PortBufInfo_v1 portBufInfo = PortBufInfo_v1( wrotoBuf.memID,wrotoBuf.virtAddr,0,wrotoBuf.bufSecu, wrotoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(1280, 720),  bufStridesInBytes, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                printf("QQ : Before create image buffer\n");
                outBuffer = pHeap->createImageBuffer();
                outBuffer->incStrong(outBuffer);
            ...
            {
                wdmaoBuf.size=2560*1440*2;
                mpImemDrv->allocVirtBuf(&wdmaoBuf);
                memset((MUINT8*)wdmaoBuf.virtAddr, 0xffffffff, wdmaoBuf.size);
                MUINT32 bufStridesInBytes[3] = {5120, 0, 0};
                PortBufInfo_v1 portBufInfo = PortBufInfo_v1( wdmaoBuf.memID,wdmaoBuf.virtAddr,0,wdmaoBuf.bufSecu, wdmaoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(2560, 1440),  bufStridesInBytes, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                printf("QQ : Before create image buffer\n");
                outBuffer = pHeap->createImageBuffer();
                outBuffer->incStrong(outBuffer);
                ...
                wrotoBuf.size=2560*1440*2;
                mpImemDrv->allocVirtBuf(&wrotoBuf);
                memset((MUINT8*)wrotoBuf.virtAddr, 0xffffffff, wrotoBuf.size);
                MUINT32 bufStridesInBytes2[3] = {5120, 0, 0};
                PortBufInfo_v1 portBufInfo2 = PortBufInfo_v1( wrotoBuf.memID,wrotoBuf.virtAddr,0,wrotoBuf.bufSecu, wrotoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam2 = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(2560, 1440),  bufStridesInBytes2, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap2 = ImageBufferHeap::create( LOG_TAG, imgParam2,portBufInfo2,true);
                printf("QQ : Before create image buffer\n");
                outBuffer2 = pHeap2->createImageBuffer();
                outBuffer2->incStrong(outBuffer2);
                outBuffer2->lockBuf(LOG_TAG,eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN);
            }
            else if(casenum==3)
            {
                wdmaoBuf.size=6400*504*2;
                mpImemDrv->allocVirtBuf(&wdmaoBuf);
                memset((MUINT8*)wdmaoBuf.virtAddr, 0xffffffff, wdmaoBuf.size);
                MUINT32 bufStridesInBytes[3] = {12800, 0, 0};
                PortBufInfo_v1 portBufInfo = PortBufInfo_v1( wdmaoBuf.memID,wdmaoBuf.virtAddr,0,wdmaoBuf.bufSecu, wdmaoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(6400, 504),  bufStridesInBytes, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap = ImageBufferHeap::create( LOG_TAG, imgParam,portBufInfo,true);
                printf("QQ : Before create image buffer\n");
                outBuffer = pHeap->createImageBuffer();
                outBuffer->incStrong(outBuffer);
            ...
            else if(casenum==4)
            {
                ...
                wrotoBuf.size=1920*1080*2;
                mpImemDrv->allocVirtBuf(&wrotoBuf);
                memset((MUINT8*)wrotoBuf.virtAddr, 0xffffffff, wrotoBuf.size);
                MUINT32 bufStridesInBytes2[3] = {3840, 0, 0};
                PortBufInfo_v1 portBufInfo2 = PortBufInfo_v1( wrotoBuf.memID,wrotoBuf.virtAddr,0,wrotoBuf.bufSecu, wrotoBuf.bufCohe);
                IImageBufferAllocator::ImgParam imgParam2 = IImageBufferAllocator::ImgParam((eImgFmt_YUY2), MSize(1920, 1080),  bufStridesInBytes2, bufBoundaryInBytes, 1);
                sp<ImageBufferHeap> pHeap2 = ImageBufferHeap::create( LOG_TAG, imgParam2,portBufInfo2,true);
                printf("QQ : Before create image buffer\n");
                outBuffer2 = pHeap2->createImageBuffer();
                outBuffer2->incStrong(outBuffer2);
            ...
            printf("QQ : outBuffer prepare done\n");
            ...
            printf("QQ : outBuffer push done\n");

        if(bV1Tunning)
        {
            applyV1Tunning_IP_TPipe(enqueParams.mFrameNo);
        }
            /////
            //temp to add, (original done in pass1)
            MUINT32 reg_val=0x0;
    ...
    //            ISP_WRITE_REG(mpIspDrv,CAM_CTL_SEL, 0, ISP_DRV_USER_ISPF);
     ...
     //           ISP_WRITE_BITS(mpIspDrv,CAM_CTL_SPARE3,INT_MRG, 1, ISP_DRV_USER_ISPF);
            ...
            if(casenum==0)
            {
                char filename[256];
                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case0_wdmao%dx%d.yuv", 640,480);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[0].mBuffer->getBufVA(0)), 640 *480 * 2);
            }
            else if(casenum==1)
            {
                char filename[256];
                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case1_wroto%dx%d.yuv", 1280,720);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[0].mBuffer->getBufVA(0)), 1280 *720 * 2);
            }
            else if(casenum==2)
            {
                char filename[256];
                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case2_wdmao%dx%d.yuv", 2560,1440);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[0].mBuffer->getBufVA(0)), 2560 *1440 * 2);

                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case2_wroto%dx%d.yuv", 2560,1440);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[1].mBuffer->getBufVA(0)), 2560 *1440 * 2);
            }
            else if(casenum==3)
            {
                char filename[256];
                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case3_wdmao%dx%d.yuv", 6400,504);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[0].mBuffer->getBufVA(0)), 6400 *504 * 2);
            }
            else if(casenum==4)
            {
                char filename[256];
                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case4_wdmao%dx%d.yuv", 2560,1440);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[0].mBuffer->getBufVA(0)), 2560 *1440 * 2);

                    printf("QQ : saveBufToFile \n");
                    sprintf(filename, "/data/P2UT_IP_TPipe_case4_wroto%dx%d.yuv", 1920,1080);
                    saveBufToFile(filename, reinterpret_cast<MUINT8*>(dequeParams.mvOut[1].mBuffer->getBufVA(0)), 1920 *1080 * 2);
            }
