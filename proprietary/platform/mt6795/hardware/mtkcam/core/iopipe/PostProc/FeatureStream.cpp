...
ESoftwareScenario const gSenDevSwScenMap[EFeatureStreamTag_total][SENSOR_DEV_MAIN_3D+1]=
{
    ...
    {eSoftwareScenario_Main_VSS_Mfb_Capture,eSoftwareScenario_Main_VSS_Mfb_Capture,eSoftwareScenario_Sub_VSS_Mfb_Capture,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Cap_Vss
    {eSoftwareScenario_Main_VSS_Mfb_Blending,eSoftwareScenario_Main_VSS_Mfb_Blending,eSoftwareScenario_Sub_VSS_Mfb_Blending,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Bld_Vss
    {eSoftwareScenario_Main_VSS_Mfb_Mixing,eSoftwareScenario_Main_VSS_Mfb_Mixing,eSoftwareScenario_Sub_VSS_Mfb_Mixing,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num},//EFeatureStreamTag_MFB_Mix_Vss
    ...
    {eSoftwareScenario_Main_IP_Raw_TPipe_Stream,eSoftwareScenario_Main_IP_Raw_TPipe_Stream,eSoftwareScenario_Sub_IP_Raw_TPipe_Stream,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num}//EFeatureStreamTag_IPRawTPipe_Stream
};
...
init()
{
    ...
    else
    {
        ...
        mpHalPipeWrapper->init(mSWScen,(unsigned long &)(this->mpPostProcPipe));
    }
