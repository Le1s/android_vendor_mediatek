...
LOCAL_SRC_FILES+= \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureDataProviderTDM.cpp \
...
ifeq ($(MTK_SPEAKER_MONITOR_SUPPORT),yes)  
  ...
  LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureHandlerModemDai.cpp
  LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureDataProviderModemDai.cpp
  LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSAPlaybackHandlerSphDL.cpp
  LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/hardware/audio/V3/speech_driver/AudioALSASpeechStreamController.cpp
  LOCAL_C_INCLUDES+= \
