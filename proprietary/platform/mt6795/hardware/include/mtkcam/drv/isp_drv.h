...
#define CAM_CTL_BNR_LINE_BUFFER                 (5312)
...
//CAM_ANR_CON1 reg 0x4a20
#define CAM_ANR_CON1_OFFSET                         (0x4A20)
...
/*/////////////////////////////////////////////////////////////////////
    CommandQ control
/////////////////////////////////////////////////////////////////////*/
#define ISP_TUNING_QUEUE_NUM        105
...
typedef struct ISP_DRV_IRQ_TIME_STRUCT
{
    ...
    :tLastEvent_sec(0x0),tLastEvent_usec(0x0)
    {}
