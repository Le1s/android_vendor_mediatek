        ...
        switch (m2a_message_id)
        {
            ...
            case MSG_M2A_RAW_PCM_REC_DATA_NOTIFY:   // meaning that we are recording, modem have some data
            {
                ...
                else
                {
                    ...
                    // SpeechProcessingHandler::getInstance()->provideCaptureDataToDataProvider(pCCCI->GetM2ARawPcmRingBuffer(ccci_buff));
#else
...
RingBuf SpeechMessengerECCCI::GetM2ARawPcmRingBuffer(const ccci_buff_t &ccci_buff)
{
    ...
    switch (mPcmRecordType)
    {
        case RECORD_TYPE_UL:
            ...
            header_ApRawPcmBuf.u16Freq = header_RawPcmBufInfo.u16ULFreq;
        ...
        case RECORD_TYPE_DL:
            header_ApRawPcmBuf.u16SyncWord = EEMCS_M2A_SHARE_BUFF_HEADER_SYNC;
            header_ApRawPcmBuf.u16RawPcmDir = RECORD_TYPE_UL;
            header_ApRawPcmBuf.u16Freq = header_RawPcmBufInfo.u16DLFreq;
            ...
            //downlink raw pcm
            PtrTarget = SeqPcmBuf + BytesCopied;
            PtrSource = (char *)ccci_buff.payload + CCCI_PAYLOAD_BUFF_HEADER_LEN + CCCI_RAW_PCM_BUFF_HEADER_LEN + header_RawPcmBufInfo.u16ULFreq;
