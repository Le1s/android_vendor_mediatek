...
status_t AudioALSAPlaybackHandlerNormal::setLowLatencyMode(bool mode, size_t lowLatencyHalBufferSize, size_t reduceInterruptSize, bool bforce)
{
    size_t buffer_size;
#ifdef MTK_DYNAMIC_CHANGE_HAL_BUFFER_SIZE
    buffer_size = lowLatencyHalBufferSize;
#else
