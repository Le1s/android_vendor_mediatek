...
static uint32_t audio_device_conv_table[][HAL_API_REV_NUM] =
{
    ...
    { AudioSystem::DEVICE_OUT_FM_TX, AUDIO_DEVICE_OUT_FM_TX},// MTK_AOSP_ENHANCEMENT
#endif
...
#ifndef MTK_BASIC_PACKAGE
    { AudioSystem::DEVICE_IN_FM, AUDIO_DEVICE_IN_FM},// MTK_AOSP_ENHANCEMENT
    { AudioSystem::DEVICE_IN_MATV, AUDIO_DEVICE_IN_MATV},// MTK_AOSP_ENHANCEMENT
#endif
};
