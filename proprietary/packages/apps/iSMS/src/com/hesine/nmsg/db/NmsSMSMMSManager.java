...
public class NmsSMSMMSManager {
    ...
    public static void updateSmsUnreadStatus(final Long threadId){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                NmsMtkBinderApi.getInstance().update(NmsSMSMMS.SMS_CONTENT_URI, values, "thread_id = ?", new String[]{String.valueOf(threadId)});
    ...
    public static String saveSmsToDb(String msg, String fromOrTo, String threadNumber, long date, long dateSent) {
        long lThreadId = -1;
        ...
        lThreadId = NmsCreateSmsThread.getOrCreateThreadId(Application.getInstance().getApplicationContext(), setThreadAddr);
