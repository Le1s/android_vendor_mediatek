...
public class Recorder implements OnCompletionListener, OnErrorListener {
    ...
    public void startRecording(int outputfileformat, String path) {
        stop();

        // if (mSampleFile == null) {
        /*
         * File sampleDir = Environment.getExternalStorageDirectory(); if
         * (!sampleDir.canWrite()) // Workaround for broken sdcard support on
         * the device. sampleDir = new
    ...
    public void startPlayback(String path) {
        stop();
        final AudioManager audioManager = (AudioManager) Application.getInstance()
                .getSystemService(Context.AUDIO_SERVICE);
//        if (NotificationSetting.getNotificationInstance(
//                Application.getInstance().getApplicationContext()).doOpenSpeaker()) {
...
//        }
    ...
    public void stopPlayback() {
        ...
        mPlayer = null;
        setState(IDLE_STATE);
        AudioManager audioManager = (AudioManager) Application.getInstance().getSystemService(
