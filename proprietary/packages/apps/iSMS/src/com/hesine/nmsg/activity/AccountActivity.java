...
import com.hesine.nmsg.activity.SexDialog.sexActionListener;
...
import com.hesine.nmsg.ui.EditAccoutDialog;
import com.hesine.nmsg.ui.HeaderView;
import com.hesine.nmsg.ui.EditAccoutDialog.ActionType;
...
//    private RadioButton femaleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mUserInfo == null) {
            ...
            MLog.trace("AccountActivity", "userInfo == null");
        }
        initView();
        setUser();
    ...
    private void initView() {
        ...
        mHeader.setTitle(this.getResources().getString(R.string.personal_info));
...
//        sexCheckButton.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
//            @Override
...
//        });
        ...
        imageAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View converToView, ViewGroup parent) {
                ...
                if (converToView == null) {
                    imageView = new ImageView(AccountActivity.this);
                    imageView.setScaleType(ScaleType.FIT_XY);
                    imageView.setLayoutParams(new GridView.LayoutParams(getResources().getDimensionPixelSize(R.dimen.list_avatar_width),
                    		getResources().getDimensionPixelSize(R.dimen.list_avatar_width)));
                } else {
	...
	private void setNameorTelNumber(final int position, String value) {
		...
		final EditAccoutDialog editAccountDialog = new EditAccoutDialog(this)
				.setInfo(
						position == 0 ? R.string.account_set_name
								: R.string.account_set_number)
		...
		editAccountDialog.setListener(new ActionListener() {
			...
			public void doAction(int type) {
				if (type == EditAccoutDialog.ActionType.ACTION_RIGHT) {
					...
					String editTextString = editAccountDialog.getText()
							.toString();
