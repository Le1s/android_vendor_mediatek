...
//        ivImage = (ImageView) mContentView.findViewById(R.id.voice_rcd_hint_anim);

        tvAudioTime = (TextView) mContentView.findViewById(R.id.AudioTime);
        mTips = (TextView) mContentView.findViewById(R.id.cancel_tips);

        mPopWindow = new PopupWindow(mContentView, CommonUtils.dp2px(mContext, 220),
                CommonUtils.dp2px(mContext, 46));
    }
