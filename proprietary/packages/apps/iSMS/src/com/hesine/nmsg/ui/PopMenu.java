...
public class PopMenu {
	private int[] itemListTitle = { R.string.menu_share,
			R.string.menu_view_contact, R.string.menu_add_contact };
	private int[] itemListImages = { R.drawable.popmenu_share,
			R.drawable.popmenu_view_contact, R.drawable.popmenu_add_contact };
	...
	private final class PopAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.groupItemTitle = (TextView) convertView
						.findViewById(R.id.popmenu_title);
				holder.groupItemImage = (ImageView) convertView
						.findViewById(R.id.popmenu_image);
