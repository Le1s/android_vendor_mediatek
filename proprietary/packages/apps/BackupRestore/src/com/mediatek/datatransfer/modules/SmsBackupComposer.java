...
public class SmsBackupComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        for (int i = 0; i < mSmsCursorArray.length; ++i) {
            if (mSmsCursorArray[i] != null && !mSmsCursorArray[i].isAfterLast()) {
                ...
                try {
                    if (mWriter != null) {
                        mWriter.write(combineVmsg(timeStamp, readByte, boxType, mSlotid, locked,
    ...
    public final void onEnd() {
        ...
        String path = mParentFolderPath + File.separator + ModulePath.NAME_SMS;
        String fileName = path + File.separator + ModulePath.SMS_VMSG;
        if (fileName != null) {
