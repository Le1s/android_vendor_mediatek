...
public class MmsBackupComposer extends Composer {
                ...
                try {
                    ...
                    if (pduMid != null) {
                        ...
                        if (Utils.isGeminiSupport() && simId >= 0) {
                            SubInfoRecord simInfo = SubscriptionManager
                                    .getSubInfoForSubscriber(simId);
                            int slot = simInfo.slotId;
    ...
    public void onEnd() {
        ...
        String path = mParentFolderPath + File.separator + ModulePath.FOLDER_MMS;
        if (path != null) {
