...
public class AlertSettingPreference extends PreferenceActivity {
    ...
    private CachedBleDeviceManager mDeviceManager;
    private CachedBleDevice mCachedDevice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceManager = CachedBleDeviceManager.getInstance();
        ...
        mRingtonePreference.setCheckStateChangeListener(mCachedDevice
        ...
        mSeekBarPreference.setOnProgressChanged(new OnSeekBarProgressChangedListener() {
            ...
            public void onProgressChanged(final int progress) {
                AlertSettingPreference.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mCachedDevice.setIntAttribute(CachedBleDevice.DEVICE_VOLUME_FLAG,
                                progress);
                    }
                });
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_SELLECT_RINGTONE) {
                ...
                String summ = RingtoneManager.getRingtone(this, mCachedDevice.getRingtoneUri())
                        .getTitle(this);
    ...
    private void updatePreferences() {
        ...
        mSeekBarPreference.setProgress(mCachedDevice
                .getIntAttribute(CachedBleDevice.DEVICE_VOLUME_FLAG));
        mVibrationPreference.setChecked(mCachedDevice
        ...
        mComposePreference.setState(mComposePreference.isEnabled(), mCachedDevice
                .getIntAttribute(CachedBleDevice.DEVICE_RANGE_VALUE_FLAG), mCachedDevice
    ...
    private void initActionBar() {
        ...
        mAlertSwitch.setChecked(mCachedDevice
                .getBooleanAttribute(CachedBleDevice.DEVICE_ALERT_SWITCH_ENABLER_FLAG));
        ...
        public void onSeekBarProgressChanged(final int startPorgress, final int stopProgress) {
            AlertSettingPreference.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    mCachedDevice.setIntAttribute(CachedBleDevice.DEVICE_RANGE_VALUE_FLAG,
                            stopProgress);
                }
            });
        }
    ...
    private NonChangeCheckBoxPreference.OnCheckStateChangeListener mRingtoneCheckStateChangeListener = new NonChangeCheckBoxPreference.OnCheckStateChangeListener() {
        ...
        public void onCheckdChangeListener(boolean checked) {
            ...
            mCachedDevice.setBooleanAttribute(CachedBleDevice.DEVICE_RINGTONE_ENABLER_FLAG,
                    checked);
            mRingtonePreference.setCheckState(mCachedDevice
                    .getBooleanAttribute(CachedBleDevice.DEVICE_RINGTONE_ENABLER_FLAG));
        }
    };
    ...
    private void showRingtoneSelector() {
        ...
        intent.putExtra(RingtoneManager.EXTRA_RINGTONE_EXISTING_URI, mCachedDevice.getRingtoneUri());
