...
public class TurnOnBTProgressDialog {
    ...
    public static void show(Activity activity) {
        ...
        sInstance.mLocalBluetoothLEManager.turnOnBluetooth();
    ...
    private TurnOnBTProgressDialog(Activity activity) {
        mLocalBluetoothLEManager = LocalBleManager.getInstance(activity);
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case SHOW_TIMEOUT_FLAG:
                ...
                mLocalBluetoothLEManager.turnOffBluetooth();
                break;
