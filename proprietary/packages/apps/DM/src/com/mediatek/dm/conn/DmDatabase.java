...
public class DmDatabase {
    ...
    private static final String DB_SUB_ID = Carriers.SUB_ID;
    ...
    private static long sRegisterSubId = -1L;
     ...
     */
    public boolean updateDmServer(long subId, String serverAddr) {
     ...
     */
    public boolean isDmApnReady(long subId) {
    ...
    private void getApnValuesFromConfFile() {
        String operatorName = mTelephonyManager.getSimOperatorName(sRegisterSubId);
    ...
    private boolean initDmApnTable(ArrayList<DmApnInfo> apnInfoList, long subId) {
