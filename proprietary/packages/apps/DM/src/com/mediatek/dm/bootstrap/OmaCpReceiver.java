...
public class OmaCpReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (CP_DM_CAPABILITY_ACTION.equals(intentAction)) {
            ...
            long subId = intent.getLongExtra(MTKPhone.SUBSCRIPTION_KEY, 0);
    ...
    private boolean handleCpConfigMessage(long subId, String serverAddr) {
        ...
        if (Options.USE_SMS_REGISTER) {
            long registerSubId = DmCommonFun.getRegisterSubID(mContext);
