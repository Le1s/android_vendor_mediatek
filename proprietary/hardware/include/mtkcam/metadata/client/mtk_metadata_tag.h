...
typedef enum mtk_camera_metadata_enum_android_scaler_available_formats {
    MTK_SCALER_AVAILABLE_FORMATS_RAW16,
    MTK_SCALER_AVAILABLE_FORMATS_RAW_OPAQUE,
    MTK_SCALER_AVAILABLE_FORMATS_YV12,
    MTK_SCALER_AVAILABLE_FORMATS_YCrCb_420_SP,
    MTK_SCALER_AVAILABLE_FORMATS_IMPLEMENTATION_DEFINED,
    MTK_SCALER_AVAILABLE_FORMATS_YCbCr_420_888,
    MTK_SCALER_AVAILABLE_FORMATS_BLOB,
...
typedef enum mtk_camera_metadata_enum_android_sensor_test_pattern_mode {
    ...
    MTK_SENSOR_TEST_PATTERN_MODE_CUSTOM1,
...
typedef enum mtk_camera_metadata_enum_android_sync_frame_number {
    MTK_SYNC_FRAME_NUMBER_CONVERGING,
    MTK_SYNC_FRAME_NUMBER_UNKNOWN,
} mtk_camera_metadata_enum_android_sync_frame_number_t;

// MTK_SYNC_MAX_LATENCY
typedef enum mtk_camera_metadata_enum_android_sync_max_latency {
    MTK_SYNC_MAX_LATENCY_PER_FRAME_CONTROL,
    MTK_SYNC_MAX_LATENCY_UNKNOWN,
