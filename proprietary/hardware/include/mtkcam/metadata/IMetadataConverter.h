...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    virtual MBOOL                   convert(const camera_metadata* src, IMetadata& dst) = 0;

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// AndroidMetadata
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    virtual MBOOL                   convert(const IMetadata& src, camera_metadata*& dst) = 0;
    virtual android::status_t                get_data_count(IMetadata const &src, size_t &entryCount, size_t &dataCount) = 0;

    virtual MVOID                   dump(IMetadata &rMetadata) = 0;
    virtual MVOID                   dumpAll(IMetadata &rMetadata) = 0;
};
