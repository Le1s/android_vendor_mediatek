...
public:     ////                            Operations.
    /**
     * Return true if this set is a subset of a given set of stream Ids.
     */
    virtual MBOOL                           isSubsetOf(
                                                android::SortedVector<StreamId_T>const& vTest
                                            ) const                             = 0;

    /**
     * Return true if this set is a superset of a given set of stream Ids.
     */
    virtual MBOOL                           isSupersetOf(
                                                android::SortedVector<StreamId_T>const& vTest
                                            ) const                             = 0;
