...
public:  ////
    ...
    IMetadataTagSet*            getTagInfo()    { return &mpTagInfo; }
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// MTKMetadata
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    MBOOL                       convert(const camera_metadata *, IMetadata &);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// AndroidMetadata
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    MBOOL                       convert(const IMetadata &, camera_metadata* &);

    status_t                    get_data_count(IMetadata const&, size_t &, size_t &);

    MVOID                       dump(IMetadata &rMetadata);
    MVOID                       dumpAll(IMetadata &rMetadata);
...
private:
	...
	MVOID                       print(IMetadata &rMetadata, MUINT32 tag, MUINT32 type);
};
