...
MBOOL
MetadataConverter::
convert(const IMetadata &rMetadata, camera_metadata* &pDstMetadata)
{
    CAM_LOGD("Convert from IMetadata to camera_metadata");
...
status_t
MetadataConverter::
get_data_count(IMetadata const &halmetadata, size_t &entryCount, size_t &dataCount)
{
    entryCount = 0;
    dataCount = 0;
