...
RIL_registerSocket (const RIL_RadioFunctionsSocket *callbacks) {
    ...
    /* atci start */
    s_fdATCI_listen= android_get_control_socket(SOCKET_NAME_ATCI);
...
*/
    switch(request) {
        ...
        case RIL_REQUEST_GET_PHONE_RAT_FAMILY: return "GET_PHONE_RAT_FAMILY";
        case RIL_REQUEST_SET_PHONE_RAT_FAMILY: return "SET_PHONE_RAT_FAMILY";
        ...
        // SMS part, ETWS primary notification
