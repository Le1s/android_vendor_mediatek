...
public class SmsManagerEx {
    ...
    public void sendTextMessage(
        ...
        long[] subIds = SubscriptionManager.getSubIdUsingSlotId(slotId);
        ...
        SmsManager.getSmsManagerForSubscriber(subIds[0]).sendTextMessage(destinationAddress,
   ...
   /**
    ...
    public void sendMultipartTextMessage(
        ...
        SmsManager.getSmsManagerForSubscriber(subIds[0]).sendMultipartTextMessage(
    ...
    public void sendDataMessage(
        ...
        SmsManager.getSmsManagerForSubscriber(subIds[0]).sendDataMessage(destinationAddress,
    ...
    public void sendTextMessageWithExtraParams(
        ...
        SmsManager.getSmsManagerForSubscriber(subIds[0]).sendTextMessageWithExtraParams(
    ...
    public void sendMultipartTextMessageWithExtraParams(String destAddr,
        ...
        SmsManager.getSmsManagerForSubscriber(subIds[0]).sendMultipartTextMessageWithExtraParams(
