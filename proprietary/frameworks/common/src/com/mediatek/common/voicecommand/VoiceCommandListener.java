...
public abstract class VoiceCommandListener {
     ...
     * @internal
     */
    public static final int ACTION_MAIN_VOICE_RECOGNITION = ACTION_COMMON + 3;
    /**
     * Voice contacts search feature.
     * @hide
     * @internal
     */
    public static final int ACTION_MAIN_VOICE_CONTACTS = ACTION_COMMON + 4;
    /**
     * Voice wake up feature.
     * @hide
     * @internal
     */
    public static final int ACTION_MAIN_VOICE_WAKEUP = ACTION_COMMON + 5;
     ...
     * @internal
     */
    public static final int ACTION_VOICE_COMMON_COMMAND_PATH = ACTION_COMMON + 1;
    /**
     * Uses to get process state for voice common feature.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_COMMON_PROCESS_STATE = ACTION_COMMON + 2;
     ...
     * @internal
     */
    public static final int ACTION_VOICE_TRAINING_PASSWORD_FILE = ACTION_COMMON + 3;
    /**
     ...
     * @internal
     */
    public static final int ACTION_VOICE_RECOGNITION_START = ACTION_COMMON + 0;
    /**
     * Uses to get voice intensity of voice recognize.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_RECOGNITION_INTENSITY = ACTION_COMMON + 1;
    /**
     * Uses to receive voice recognize result callback from service.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_RECOGNITION_NOTIFY = ACTION_COMMON + 2;
     ...
     * @internal
     */
    public static final int ACTION_VOICE_CONTACTS_SPEECH_DETECTED = ACTION_COMMON + 8;
    /**
     * Uses to send needed contacts count to swip.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_CONTACTS_SEARCH_COUNT = ACTION_COMMON + 9;
    /**
     ...
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_ENABLE = ACTION_COMMON + 1;
    /**
     * Uses to disable voice wake up.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_DISABLE = ACTION_COMMON + 2;
    /**
     * Uses to receive voice wake up result callback from service.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_NOTIFY = ACTION_COMMON + 3;
    /**
     * Uses to send init model/speak model to MD32.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_INIT = ACTION_COMMON + 4;
    /**
     * Uses to send wake up mode to MD32.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_MODE = ACTION_COMMON + 5;
    /**
     * Uses to send wake up commands status to MD32.
     * @hide
     * @internal
     */
    public static final int ACTION_VOICE_WAKEUP_COMMAND_STATUS = ACTION_COMMON + 6;
    /**
     * Uses to send ipo shutdown status to MD32.
     */
    public static final int ACTION_VOICE_WAKEUP_SHUTDOWN_IPO = ACTION_COMMON + 7;
