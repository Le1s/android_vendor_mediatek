...
public class WifidisplayFwkTest extends AndroidTestCase {
    ...
    private static final String mWfdPeerString = "P2P-DEVICE-FOUND 99:88:77:66:55:44 p2p_dev_addr=99:88:77:66:55:44 pri_dev_type=8-0050F204-2 name='WFD_DONGLE_KENPING' config_methods=0x188 dev_capab=0x24 group_capab=0x58 wfd_dev_info=0x0111022a0064";
    private static final String mWfdGroupCreatedString = "P2P-GROUP-STARTED p2p0 client ssid=\"DIRECT-BwWFD_DONGLE_KENPING\" freq=2437 psk=8781123cf06b534bb1ebebd386bc0bea0256e1532048d15ca07f276588353e2b go_dev_addr=99:88:77:66:55:44";
                ...
                synchronized (mMySyncWfd) {
                    ...
                    for (WifiDisplay d : displays) {
                        ...
                        if (d.isAvailable()) {
                            ...
                            if (d.getDeviceAddress().equals("99:88:77:66:55:44")) {
    ...
    protected void setUp() throws Exception {
        ...
        mChannel = mWifiP2pManager.initializeInternal(mContext, mContext.getMainLooper(), null);
    ...
    private void connectWfdPeer()throws Exception {
        ...
        synchronized (mMySyncWfd) {
            ...
            mDisplayManager.connectWifiDisplay("99:88:77:66:55:44");
            Log.d(TAG, "dongle MAC is " + "99:88:77:66:55:44");
