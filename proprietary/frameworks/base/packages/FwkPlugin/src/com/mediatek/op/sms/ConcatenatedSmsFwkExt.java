...
public class ConcatenatedSmsFwkExt implements IConcatenatedSmsFwkExt {
    ...
    private void checkOutOfDateSegments() {
        ...
        try {
            String where = "sub_id=?";
            long subId = SubscriptionManager.getSubIdUsingPhoneId(mPhoneId);
            String[] whereArgs = {Long.toString(subId)};
            ...
            if (cursor != null) {
                ...
                for (int i = 0; i < cursorCount; ++i) {
                    ...
                    int phoneId = SubscriptionManager.getPhoneId(cursor.getLong(columnSubId));
